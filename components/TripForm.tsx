...
export default function TripForm() {
    ...
    const handleSubmit = (e: React.SubmitEvent) => {
        ...
        console.log("Validated trip data:", formData);
    }
    ...
    return (
        ...
        onSubmit={handleSubmit}>
            ...
            <div>
                ...
                {error && <p role="alert" className="text-red-600/80 text-sm mb-2 rounded-xl border border-red-600/60 p-2 text-center bg-ivory">{error}</p>}
            ...
            <button 
                className="w-full py-4 rounded-xl bg-charcoal text-ivory font-medium hover:bg-charcoal/90 transition-all mt-4 shadow-md cursor-pointer" 
                type="submit"
            >
                Generate my list
            </button>
